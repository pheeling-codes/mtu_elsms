-- Final working reservation function
-- Uses simple approach to avoid all schema issues
...
COMMENT ON FUNCTION create_reservation_final IS 'Final working reservation function with standard column names';
